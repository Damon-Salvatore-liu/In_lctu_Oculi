...
import pickle
from .face_utils import lib
from .vid_utils import proc_vid as pv
...
#     test = Solu("F:/projects/WIFS2018_In_Ictu_Oculi/toy/demo/0001.mp4")
#     test.plot_by_fid(10)
#     test.gen_videos('F:\\projects\\In_lctu_Oculi\\temp')